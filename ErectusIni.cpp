...
ScrapLooterSettings DefaultScrapLooterSettings
{
	...
	{
	"Черный титан",//0x00017DE8
	"Ультрацит",//0x00017DE9
	"Кислота",//0x0001FA8C
	"Алюминий",//0x0001FA91
	"Защитные волокна",//0x0001FA94
	"Антисептик",//0x0001FA96
	"Асбест",//0x0001FA97
	"Кости",//0x0001FA98
	"Керамика",//0x0001FA9A
	"Схемы",//0x0001FA9B
	...
	"Пробка",//0x0001FA9D
	"Кристал",//0x0001FA9F
	"Оптическое волокно",//0x0001FAA0
	"Стекловолокно",//0x0001FAA1
	"Стекло",//0x0001FAA4
	"Клей",//0x0001FAA5
	"Золото",//0x0001FAA6
	"Свинец",//0x0001FAAD
	"Кожа",//0x0001FAAE
	"Шестеренки",//0x0001FAB0
	"Ядерный материал",//0x0001FAB3
	"Масло",//0x0001FAB4
	"Пластик",//0x0001FAB7
	"Резина",//0x0001FAB9
	"Серебро",//0x0001FABB
	...
	"Болт",//0x0003D294
	"Бетон",//0x0005A0C4
	"Удобрение",//0x0005A0C7
	"Ткань",//0x001223C7
	"Кобальтовый флюс",//0x002B9178
	"Флуоресцентный флюс",//0x002B917A
	"Фиолетовый флюс",//0x002B917C
	"Алый флюс",//0x002B917E
	"Урановый флюс",//0x002B9180
	"Уголь",//0x0031C09A
	"Сталь убежищя 94",//0x0054E4FA
	},
};
...
HarvesterSettings DefaultHarvesterSettings
{
	...
	},
	{
		...
		"Илофасоль",
		"Цветок саженца",
		"Токсичный цветок саженца",
		"Чертополох",
		"Цветок Рододендрона",
		"Огненный гриб",
		"Хвостолом",
		"Ягоды ночного ползуна",
		"Мутированный цветок",
		"Сухая трава",
		"Астра",
		"Гриб",
